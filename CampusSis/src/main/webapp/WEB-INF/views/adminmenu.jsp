<%@ page language="java" contentType="text/html; charset=UTF-8"
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="/campus/student" class="nav-link">Contact</a>
      </li>
    </ul>
  ...
  <p class="fas">HOME</p>
          ...
          <li class="nav-item">
            <a href="pages/widgets.html" class="nav-link">
              <i class="nav-icon fas key-img-icon"></i>
              <p class="fas">&nbsp;
                계정관리
              </p>
            </a>
           ...
           <li class="nav-item">
            <a href="pages/widgets.html" class="nav-link">
              <i class="nav-icon fas poli-img-icon"></i>
              <p class="fas">&nbsp;
                신고 관리
              </p>
            </a>
           ...
           <li class="nav-item">
            <a href="pages/widgets.html" class="nav-link">
              <i class="nav-icon fas log-img-icon"></i>
              <p class="fas">&nbsp;
                감사 로그
              </p>
            </a>
